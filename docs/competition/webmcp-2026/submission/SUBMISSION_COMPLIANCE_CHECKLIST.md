# WebMCP Challenge Submission Compliance

## Required

- [x] Registered on Devpost.
- [x] Working public live URL.
- [x] English judge-facing interface.
- [x] English project story and testing instructions drafted.
...
- [x] No fabricated trend or video records.
- [x] Empty video results described as valid empty data.
- [x] Safari website fallback separated from native WebMCP validation.
- [x] Pre-challenge trend features not claimed as challenge work.
- [x] No user, revenue, accuracy, or partnership claims added.
...
After final submission, do not modify the submitted repository, video, live site, or Devpost entry during judging unless the organizer explicitly permits it.
