...
export function ReviewPage() {
  ...
  return <section className="review-page">
    <div className="review-hero"><div><span className="review-version">地區熱搜與八平台候選版 0.4｜第二次測試候選版</span><h1>熱門引擎｜公開測試審核</h1><p>這個版本使用可追溯來源，驗證市場地區、情報類型、八平台影音入口、網址匯入、取得方式與證據流程。</p></div><div className="review-mock-seal real-data-seal" aria-label="公開測試版"><strong>公開</strong><span>測試版</span></div></div>
    ...
    <div className="review-scope-grid"><article><span className="review-card-label">本次範圍</span><h2>可驗證內容</h2><p>四個市場與全部地區、六種情報類型、八個影音平台、地區預設平台、官方與輔助來源、網址匯入、搜尋、篩選及證據。</p></article><article><span className="review-card-label excluded">重要限制</span><h2>平台能力依實際權限提供</h2><p>目前只有YouTube官方API自動取得；其他平台依權限狀態提供官方網站輔助或使用者分享。新聞篇數不會冒充搜尋量或觀看數。</p></article></div>
    ...
    <div className="review-actions" aria-label="審核捷徑"><Link className="button trend-primary" to="/trends">開始審核</Link><Link className="button secondary" to="/trends/video-search">查看地區與八平台搜尋</Link><Link className="button secondary" to="/trends/search">查看搜尋與篩選</Link><Link className="button secondary" to="/trends/watchlist">查看觀察清單</Link><Link className="button secondary" to="/trends/sources">查看資料來源狀態</Link></div>
  </section>;
}
