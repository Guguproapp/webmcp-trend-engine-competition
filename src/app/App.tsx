...
import { AgentWorkspacePage } from '../modules/webmcp/presentation/AgentWorkspacePage';

export function App() {
  return <Routes><Route element={<AppShell />}><Route index element={<ProductHomePage />} /><Route path="/guide" element={<GuidePage />} /><Route path="/review" element={<Navigate to="/" replace />} /><Route path="/agent-workspace" element={<AgentWorkspacePage />} /><Route path="/trends" element={<TrendOverviewPage />} /><Route path="/trends/search" element={<TrendSearchPage />} /><Route path="/trends/video-search" element={<VideoSearchPage />} /><Route path="/trends/watchlist" element={<TrendWatchlistPage />} /><Route path="/trends/excluded" element={<TrendExcludedPage />} /><Route path="/trends/rules" element={<TrendRulesPage />} /><Route path="/trends/sources" element={<TrendSourcesPage />} /><Route path="/trends/:topicId" element={<TrendDetailPage />} /><Route path="*" element={<ProductBoundaryPage />} /></Route></Routes>;
}
