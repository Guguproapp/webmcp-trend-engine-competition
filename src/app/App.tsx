...
export function App() {
  return <Routes><Route element={<AppShell />}><Route index element={<ProductHomePage />} /><Route path="/guide" element={<GuidePage />} /><Route path="/review" element={<Navigate to="/" replace />} /><Route path="/agent-workspace" element={<Navigate to="/radar-tools" replace />} /><Route path="/radar-tools" element={<RadarToolsPage />} /><Route path="/trends" element={<TrendOverviewPage />} /><Route path="/trends/search" element={<TrendSearchPage />} /><Route path="/trends/video-search" element={<VideoSearchPage />} /><Route path="/trends/watchlist" element={<TrendWatchlistPage />} /><Route path="/trends/excluded" element={<TrendExcludedPage />} /><Route path="/trends/rules" element={<TrendRulesPage />} /><Route path="/trends/sources" element={<TrendSourcesPage />} /><Route path="/trends/:topicId" element={<TrendDetailPage />} /><Route path="*" element={<ProductBoundaryPage />} /></Route></Routes>;
}
